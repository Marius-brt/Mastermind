...
public class Fenetre extends JFrame {
	...
	public static void createFenetre(int w, int h, String titre) {
		/*
		 * Role : creation de l'unique objet/instance de la classe Fenetre. L'attribut de classe
		 * THEFENETRE permet de stocker cette unique fenetre creee. L'attribut de classe booleen
		 * thereIsInstance est mis a true par le constructeur, empechant la creation future d'une
		 * deuxieme fenetre.
		 */
		if (!thereIsInstance)
